...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExcepcionServicioNoActivo.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
        CODIGOS_ESTADO.put(ExcepcionServicioActivo.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
