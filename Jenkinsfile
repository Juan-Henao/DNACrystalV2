    ...
    stages{
        stage('Checkout') {
            ...
            checkout([
                ...
                url:'https://github.com/Juan-Henao/DNACrystalV2']]
                ])
            }
        }
    ...
    post {
        ...
        failure {
            echo 'This will run only if failed'
             mail (to: 'juan.henao@ceiba.com.co',subject: "Failed Pipeline:${currentBuild.fullDisplayName}",body: "Something is wrong with ${env.BUILD_URL}")
        }
        unstable {
